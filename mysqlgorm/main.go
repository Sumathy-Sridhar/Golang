...
//Reference link
//https://www.soberkoder.com/go-rest-api-mysql-gorm/#:~:text=Build%20a%20REST%20API%20in%20Golang%20with%20MySQL%2C,details%20of%20an%20order.%20...%20More%20items...%20
import (
	"encoding/json"
	"fmt"
	"log"
...
func initDB() {
	var err error
	dataSourceName := "root:root@tcp(localhost:3306)/godbconn"
